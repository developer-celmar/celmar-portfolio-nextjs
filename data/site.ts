export const siteData = {
  ...
  objective:
    "To work in an organization where I can contribute, utilize, and cultivate my skills in a role aligned with the job description while growing with the institution.",
};

export const stats = [
  { label: "Years across tech & projects", value: "10+" },
  { label: "Published mobile apps", value: "7" },
  { label: "Current leadership role", value: "PSO IV" },
];
...
export const experience = [
  {
    role: "Presidential Staff Officer IV",
    company: "Office of the President of the Philippines",
...
export const education = [
  "Master of Public Administration, Polytechnic University of the Philippines (March 2022 - Present, 9 units)",
...
export const apps = [
  "The Swan Princess",
  "Fashion Angels Virtual Reality Runway",
  "Blastbox",
  "Stik’em",
  "Stikbot Studio",
  "WetHead",
